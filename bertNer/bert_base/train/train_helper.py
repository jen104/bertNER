...
def get_args_parser():
    ...
    if os.name == 'nt':
        bert_path = 'bert_base/bert/chinese_L-12_H-768_A-12'
    else:
    ...
    group1.add_argument('-data_dir', type=str, default= 'NERdata',
    ...
    group1.add_argument('-output_dir', type=str, default= 'output',
